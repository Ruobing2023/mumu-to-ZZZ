...
void AnalyseEvents(ExRootTreeReader *treeReader, TString filename)
{
	...
	double SF=1.0;
	if(filename.Contains("ZZZ")) {SF= 1.026e-3/10000.;}
	if(filename.Contains("ZZZ-1TeV-llvl_output")==1) {SF= 1.026e-3/10000.;}
	...
	int inputNum=0;
	int event;
	double chargeMu11,chargeMu12,Chargesum,chargeEl11,chargeEl12,Chargesum1;
	...
	tree->Branch("chargeMu11",&chargeMu11,"chargeMu11/D");
	tree->Branch("chargeMu12",&chargeMu12,"chargeMu12/D");
	tree->Branch("Chargesum",&Chargesum,"Chargesum/D");
	tree->Branch("chargeEl11",&chargeEl11,"chargeEl11/D");
	tree->Branch("chargeEl12",&chargeEl12,"chargeEl12/D");
	tree->Branch("Chargesum1",&Chargesum1,"Chargesum1/D");
	...
	for(int count=0; count < numberOfEntries; count++) {
		...
		chargeMu12=-99;chargeMu11=-99.;Chargesum=-99.;
		//********************************************************************
		for(int i=0; i<99; i++)
		{
...
/*		if((numEl+numMu)!=4)continue;
		...
		if(numEl==1&&numMu==3)continue;*/
		  if( !( ((numMu==2)&&(numEl==2)) || ((numMu==4)&&(numEl==0)) || ((numMu==0)&&(numEl==4)) ) ) {
                        ...
                        //cout<<"No correct leptons number!"<<endl;
                        //cout<<"++++++++++++"<<endl;
                        continue;
                }
		double Mz = 91.0 ;
		...
		int mark3=0;
		int mark4=0;
		double MMass=1.056600e-01; // modification from chuqiao jiang
		double MMass2=5.110000e-04; // modification from chuqiao jiang
		TLorentzVector l1,l2,l3,l4;
		if(numMu==2&&numEl==2){
			mark2 = 0; // modification from chuqiao jiang
			for(int j=0; j<2 /*the numbers of Mu and El are all 2*/; j++){
			...
			//.
			//.
			// some repeated codes are removed
			//.
			//.
			//.
			//-------------------------
			//   if((l1+l4).M()<85.||(l1+l4).M()>100.)continue;
			//   if((l3+l2).M()<85.||(l3+l2).M()>100.)continue; 
			Pt4l=(l1+l2+l3+l4).Pt();
			M4l=(l1+l2+l3+l4).M();
			Mrecoil=sqrt(pow((1000.-(l1+l2+l3+l4).E()),2)-pow((l1+l2+l3+l4).Pt(),2)-pow((l1+l2+l3+l4).Pz(),2));
			deltaM1423=pow(((l1+l4).M()-Mz),2)+pow(((l3+l2).M()-Mz),2); //注释：z只能衰变到同种味道的正负轻子对，对于numMu==2&&numEl==2的情况只有一种组合。
			deltaM=deltaM1423;
			Mll1=(l1+l4).M();
			Ptll1=(l1+l4).Pt();
			Mll2=(l2+l3).M();
			Ptll2=(l2+l3).Pt();
		//	chargeMu11=l1.Charge();
		//	chargeMu12=l2.Charge();
		}
		if(numMu==4&&numEl==0){
		        mark2 = 0; // modification from chuqiao jiang
	...
	//		if(mark2!=4)continue;
			...
			if(chargeMu2[0]+chargeMu2[1]+chargeMu2[2]+chargeMu2[3]!=0)continue;
			
			if(chargeMu2[0]==1 && chargeMu2[1]==-1){
		    
				if(chargeMu2[2]==1 && chargeMu2[3]==-1){
					l1.SetPtEtaPhiM(ptMu2[0],etaMu2[0],phiMu2[0],MMass);
					l2.SetPtEtaPhiM(ptMu2[1],etaMu2[1],phiMu2[1],MMass);   
			...
			if(chargeMu2[0]==-1 && chargeMu2[1]==1){
			if(chargeMu2[2]==1 && chargeMu2[3]==-1){
			if((chargeMu2[1]+chargeMu2[0])!=0&&(chargeMu2[1]+chargeMu2[3])!=0)continue;
			if((chargeMu2[0]+chargeMu2[2])!=0&&(chargeMu2[2]+chargeMu2[3])!=0)continue;
				
					l1.SetPtEtaPhiM(ptMu2[1],etaMu2[1],phiMu2[1],MMass);
					l2.SetPtEtaPhiM(ptMu2[0],etaMu2[0],phiMu2[0],MMass);   
					l3.SetPtEtaPhiM(ptMu2[2],etaMu2[2],phiMu2[2],MMass);
					l4.SetPtEtaPhiM(ptMu2[3],etaMu2[3],phiMu2[3],MMass);
				}
			if(chargeMu2[2]==-1 && chargeMu2[3]==1){
			if((chargeMu2[1]+chargeMu2[0])!=0&&(chargeMu2[1]+chargeMu2[2])!=0)continue;
			if((chargeMu2[0]+chargeMu2[3])!=0&&(chargeMu2[2]+chargeMu2[3])!=0)continue;
					l1.SetPtEtaPhiM(ptMu2[1],etaMu2[1],phiMu2[1],MMass);
					l2.SetPtEtaPhiM(ptMu2[0],etaMu2[0],phiMu2[0],MMass);   
					l3.SetPtEtaPhiM(ptMu2[3],etaMu2[3],phiMu2[3],MMass);
					l4.SetPtEtaPhiM(ptMu2[2],etaMu2[2],phiMu2[2],MMass);
			...
			if(chargeMu2[0]==1 && chargeMu2[1]==1 && chargeMu2[2]==-1 && chargeMu2[3]==-1){
				if((chargeMu2[0]+chargeMu2[2])!=0&&(chargeMu2[0]+chargeMu2[3])!=0)continue;
				if((chargeMu2[1]+chargeMu2[2])!=0&&(chargeMu2[1]+chargeMu2[3])!=0)continue;
				
					l1.SetPtEtaPhiM(ptMu2[0],etaMu2[0],phiMu2[0],MMass);
					l2.SetPtEtaPhiM(ptMu2[2],etaMu2[2],phiMu2[2],MMass);   
					l3.SetPtEtaPhiM(ptMu2[1],etaMu2[1],phiMu2[1],MMass);
					l4.SetPtEtaPhiM(ptMu2[3],etaMu2[3],phiMu2[3],MMass);
			}
			if(chargeMu2[0]==-1 && chargeMu2[1]==-1 && chargeMu2[2]==1 && chargeMu2[3]==1){
				...
				if((chargeMu2[0]+chargeMu2[2])!=0&&(chargeMu2[0]+chargeMu2[3])!=0)continue;
				if((chargeMu2[1]+chargeMu2[2])!=0&&(chargeMu2[1]+chargeMu2[3])!=0)continue;
					l1.SetPtEtaPhiM(ptMu2[2],etaMu2[2],phiMu2[2],MMass);
					l2.SetPtEtaPhiM(ptMu2[0],etaMu2[0],phiMu2[0],MMass);   
					l3.SetPtEtaPhiM(ptMu2[3],etaMu2[3],phiMu2[3],MMass);
					l4.SetPtEtaPhiM(ptMu2[1],etaMu2[1],phiMu2[1],MMass);
			}

			//-------------------------
			//   if(((l1+l2).M()+<170.||(l1+l2+l3+l4).M()>190.)continue;
			//   if((l1+l2).M()<85.||(l1+l2).M()>100.)continue;
			//   if((l3+l4).M()<85.||(l3+l4).M()>100.)continue;
			//   if((l1+l4).M()<85.||(l1+l4).M()>100.)continue;
			//   if((l3+l2).M()<85.||(l3+l2).M()>100.)continue;
			Pt4l=(l1+l2+l3+l4).Pt();
			M4l=(l1+l2+l3+l4).M();
		...
		if(numEl==4&&numMu==0){
			...
			for(int j2=0; j2<numLep; j2++){
				...
				mark2++;
                  ...
                  //      if(mark2!=4)continue;
			if((chargeEl2[0]+chargeEl2[1]+chargeEl2[2]+chargeEl2[3])!=0) continue;
			if(chargeEl2[0]==1 && chargeEl2[1]==-1){
		   
			if(chargeEl2[2]==1 && chargeEl2[3]==-1){
		    if((chargeEl2[0]+chargeEl2[1])!=0&&(chargeEl2[0]+chargeEl2[3])!=0)continue;
		    if((chargeEl2[3]+chargeEl2[2])!=0&&(chargeEl2[1]+chargeEl2[2])!=0)continue;
					l1.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);
					l2.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);
					l4.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
				}
				if(chargeEl2[2]==-1 && chargeEl2[3]==1){
			if((chargeEl2[0]+chargeEl2[1])!=0&&(chargeEl2[0]+chargeEl2[2])!=0)continue;
		    if((chargeEl2[3]+chargeEl2[2])!=0&&(chargeEl2[3]+chargeEl2[1])!=0)continue;
					l1.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);
					l2.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
					l4.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);
				}
			}
			if(chargeEl2[0]==-1 && chargeEl2[1]==1){
			if(chargeEl2[2]==1 && chargeEl2[3]==-1){
			if((chargeEl2[0]+chargeEl2[1])!=0&&(chargeEl2[1]+chargeEl2[3])!=0)continue;
		    if((chargeEl2[3]+chargeEl2[2])!=0&&(chargeEl2[0]+chargeEl2[2])!=0)continue;
			
					l1.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);
					l2.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);
					l4.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
				}
				if(chargeEl2[2]==-1 && chargeEl2[3]==1){
			if((chargeEl2[0]+chargeEl2[1])!=0&&(chargeEl2[1]+chargeEl2[2])!=0)continue;
		    if((chargeEl2[3]+chargeEl2[2])!=0&&(chargeEl2[3]+chargeEl2[0])!=0)continue;
					l1.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);
					l2.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
					l4.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);
			...
			if(chargeEl2[0]==1 && chargeEl2[1]==1 && chargeEl2[2]==-1 && chargeEl2[3]==-1){
			if((chargeEl2[0]+chargeEl2[2])!=0&&(chargeEl2[0]+chargeEl2[3])!=0)continue;
		    if((chargeEl2[1]+chargeEl2[2])!=0&&(chargeEl2[1]+chargeEl2[3])!=0)continue;
					
					l1.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);
					l2.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);
					l4.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
			}
			if(chargeEl2[0]==-1 && chargeEl2[1]==-1 && chargeEl2[2]==1 && chargeEl2[3]==1 ){
			if((chargeEl2[0]+chargeEl2[2])!=0&&(chargeEl2[0]+chargeEl2[3])!=0)continue;
		    if((chargeEl2[1]+chargeEl2[2])!=0&&(chargeEl2[1]+chargeEl2[3])!=0)continue;
					...
					l1.SetPtEtaPhiM(ptEl2[2],etaEl2[2],phiEl2[2],MMass2);
					l2.SetPtEtaPhiM(ptEl2[0],etaEl2[0],phiEl2[0],MMass2);   
					l3.SetPtEtaPhiM(ptEl2[3],etaEl2[3],phiEl2[3],MMass2);
					l4.SetPtEtaPhiM(ptEl2[1],etaEl2[1],phiEl2[1],MMass2);
			}
...
void ntuple_chain1_updated(string filename = "mumuTozzzTollllvlvl_1TeV")
{
	gSystem->Load("/home/pku/jiangcq/trial_condor_madgraph/MG5_aMC_v3_5_0/Delphes/libDelphes");
	//THStack *stack;
